...
public final class Timeline {
  ...
  private static final short FORMAT_VERSION=6;
  ...
  public static final class Codec {
    ...
    private static void writePacket(DataOutputStream out,Packet p)throws IOException{
      ...
      else if(p instanceof FlightToggle v){out.writeByte(17);out.writeBoolean(v.flying());out.writeBoolean(v.cancelled());}
    ...
    private static Packet readPacket(DataInputStream in)throws IOException{return switch(in.readUnsignedByte()){
      ...
      case 9->new ChunkUnload(readChunk(in));case 10->new BlockChange(readPos(in),readBlock(in));case 11->new BlockStateChange(readWorldPos(in),readBlockState(in));case 13->new UnsupportedBlockStateChange(readWorldPos(in),readBlockState(in));      case 15->new WorldTransactionSend(in.readShort());case 17->new FlightToggle(in.readBoolean(),in.readBoolean());case 16->new WorldTransactionAck(in.readShort());
