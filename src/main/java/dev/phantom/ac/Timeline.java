...
public final class Timeline {
  ...
  public static final class Codec {
    ...
    private static Packet readPacket(DataInputStream in)throws IOException{return switch(in.readUnsignedByte()){
      ...
      case 9->new ChunkUnload(readChunk(in));case 10->new BlockChange(readPos(in),readBlock(in));case 11->new BlockStateChange(readWorldPos(in),readBlockState(in));case 13->new UnsupportedBlockStateChange(readWorldPos(in),readBlockState(in));      case 15->new WorldTransactionSend(in.readShort());case 16->new WorldTransactionAck(in.readShort());
