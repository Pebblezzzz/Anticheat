...
public final class Timeline {
  ...
  private static final short FORMAT_VERSION=9;
  ...
  /** Fixed binary replay format. v9 persists lossless block-state properties; v8 remains readable. */
  public static final class Codec {
    ...
    private static Packet readPacket(DataInputStream in,int version)throws IOException{return switch(in.readUnsignedByte()){
      ...
      case 9->new ChunkUnload(readChunk(in));case 10->new BlockChange(readPos(in),readBlock(in));case 11->new BlockStateChange(readWorldPos(in),readBlockState(in));case 13->new UnsupportedBlockStateChange(readWorldPos(in),readBlockState(in));case 19->new PaperMovementRejection(readString(in),in.readBoolean());      case 15->new WorldTransactionSend(in.readShort());case 18->new FlightToggle(in.readBoolean(),in.readBoolean());case 16->new WorldTransactionAck(in.readShort());
