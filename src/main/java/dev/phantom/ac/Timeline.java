...
public final class Timeline {
  ...
  private static final short FORMAT_VERSION=8;
  ...
  /** Fixed binary replay format. v1-v6 are accepted for backward-compatible decoding; v7 adds Paper movement telemetry. */
