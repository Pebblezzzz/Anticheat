...
public final class Phase6Reachability {
  ...
  public record InputConstraint(OptionalInt forward,OptionalInt strafe,Optional<Boolean> jump,Optional<Boolean> sprint,Optional<Boolean> sneak) implements Serializable {
    ...
    public static InputConstraint fromClientInput(Packets.ClientInput i){Objects.requireNonNull(i);return new InputConstraint(OptionalInt.of(axis(i.forward(),i.backward())),OptionalInt.of(axis(i.left(),i.right())),Optional.of(i.jump()),Optional.of(i.sprint()),Optional.of(i.sneak()));}
