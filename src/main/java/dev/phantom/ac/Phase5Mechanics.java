...
public final class Phase5Mechanics {
  ...
  /** Movement effects use decoded vanilla amplifiers; -1 means absent. */
  public record MovementEffects(int speedAmplifier,int slownessAmplifier,int jumpBoostAmplifier,
                                int levitationAmplifier,boolean slowFalling) implements Serializable {
    ...
    /** Compatibility constructor for existing fixtures that only tracked levitation presence. */
    public MovementEffects(int speedAmplifier,int slownessAmplifier,int jumpBoostAmplifier,boolean levitation,boolean slowFalling){
      this(speedAmplifier,slownessAmplifier,jumpBoostAmplifier,levitation?-1: -1,slowFalling);
    }
  ...
  public record Combination(Pose pose,Fluid fluid,boolean climbable,boolean sprint,boolean sneak,boolean jump,
                            boolean gliding,boolean knockedBack,boolean stepping,boolean corrected) implements Serializable {}
}
