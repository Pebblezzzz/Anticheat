...
public final class Phase4WorldReplica implements Serializable {
  ...
  public synchronized WorldSnapshot snapshotAtOrBeforeIncludingPending(long sequence){
     ...
     * entire visible world at this sequence; only still-pending block updates
     * need a short-lived overlay. Replaying the complete event journal here
     * would make validation cost grow with player uptime and packet history.
     */
