...
public final class Simulation {
  ...
  /** Server-authoritative movement permissions/state. Client claims never grant flight capability. */
  public record MovementCapabilities(boolean canFly, boolean flying) implements Serializable {
    public static final MovementCapabilities NONE=new MovementCapabilities(false,false);
    public boolean authorizedFlight(){return canFly&&flying;}
  }
