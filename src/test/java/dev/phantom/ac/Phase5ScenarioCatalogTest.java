...
class Phase5ScenarioCatalogTest {
    ...
    void requiredManifestHasNoDuplicatesAndCoversPreviouslyMissingScenarioFamilies() {
        ...
        for (String required : List.of(
                ...
                "edge", "corner", "corner-sprint", "deep-swimming", "water-sprint", "ladder-sprint", "vines",
                "slow-falling", "levitation", "attribute-modifier", "knockback-ground", "knockback-air",
                "teleport-water", "sleeping", "step-sprint-jump")) {
            assertTrue(ids.contains(required), "missing scenario " + required);
        }
    }
    ...
    void corpusAuditRejectsTheOldSyntheticPostTickAndPlaceholderContract() {
        ...
        columns[11] = "true";
        columns[12] = columns[13] = "0";
        columns[14] = columns[15] = columns[16] = "false";
        columns[17] = "STANDING";
        columns[18] = "survival";
        columns[19] = "NONE";
        ...
        columns[23] = "0.1";
        columns[24] = "-";
        columns[25] = columns[26] = columns[27] = "-1";
        columns[30] = columns[31] = columns[32] = "0.0";
        columns[34] = "-1";
        columns[36] = "test-world";
        columns[37] = "1";
        columns[44] = "capture-post-tick:legacy:walk";
        ...
        Phase5VanillaTrace.Row row = new Phase5VanillaTrace.Row(columns, Set.of(
                "step_attempted", "step_succeeded", "collision_x", "collision_y", "collision_z",
                "knockback_x", "knockback_y", "knockback_z", "correction_pending"));
